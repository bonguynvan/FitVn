...
const List<CatalogExercise> seedExercises = [
  ...
  CatalogExercise(id: 'bench_press', nameVi: 'Đẩy ngực (bench press)', muscleGroup: 'chest'),
  CatalogExercise(id: 'overhead_press', nameVi: 'Đẩy vai', muscleGroup: 'shoulders'),
  ...
  CatalogExercise(id: 'biceps_curl', nameVi: 'Cuốn tạ tay trước', muscleGroup: 'biceps'),
  CatalogExercise(id: 'triceps_pushdown', nameVi: 'Đẩy tạ tay sau', muscleGroup: 'triceps'),
